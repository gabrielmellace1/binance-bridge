...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { Binance } from './../controllers/binance.controller';
...
const models: TsoaRoute.Models = {
    "IBinanceLink": {
        "dataType": "refObject",
        "properties": {
            "prepayId": {"dataType":"string","required":true},
            "terminalType": {"dataType":"string","required":true},
            "expireTime": {"dataType":"double","required":true},
            "qrcodeLink": {"dataType":"string","required":true},
            "qrContent": {"dataType":"string","required":true},
            "checkoutUrl": {"dataType":"string","required":true},
            "deeplink": {"dataType":"string","required":true},
            "universalUrl": {"dataType":"string","required":true},
        },
    ...
    "IAPIResponse_IBinanceLink_": {
        "dataType": "refObject",
        "properties": {
            "data": {"ref":"IBinanceLink","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/binance/getBinancePaymentLink',
            ...(fetchMiddlewares<RequestHandler>(Binance)),
            ...(fetchMiddlewares<RequestHandler>(Binance.prototype.getBinancePaymentLink)),

            function Binance_getBinancePaymentLink(request: any, response: any, next: any) {
            const args = {
                    buyerAddress: {"in":"query","name":"buyerAddress","required":true,"dataType":"string"},
                    sellerAddress: {"in":"query","name":"sellerAddress","required":true,"dataType":"string"},
                    amount: {"in":"query","name":"amount","required":true,"dataType":"string"},
                    currency: {"in":"query","name":"currency","required":true,"dataType":"enum","enums":["USDT"]},
            };
            ...
            try {
                ...
                const controller = new Binance();


              const promise = controller.getBinancePaymentLink.apply(controller, validatedArgs as any);
