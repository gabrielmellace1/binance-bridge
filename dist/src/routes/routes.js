...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/binance/getBinancePaymentLink', ...((0, runtime_1.fetchMiddlewares)(binance_controller_1.Binance)), ...((0, runtime_1.fetchMiddlewares)(binance_controller_1.Binance.prototype.getBinancePaymentLink)), function Binance_getBinancePaymentLink(request, response, next) {
        const args = {
        ...
        try {
            ...
            const controller = new binance_controller_1.Binance();
            const promise = controller.getBinancePaymentLink.apply(controller, validatedArgs);
